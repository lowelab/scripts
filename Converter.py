...
Usage ="""
Converter.py - version 1.1	created 28/11/2013, last update 23/12/2013
Convert STRUCTURE SNP input file (0,1; tab delimited txt file) into TREEMIX input file.
...
#	for i in OutLOS:
#		print i				
	OutputFileName = 'TreeMix_' + File + '.txt'
